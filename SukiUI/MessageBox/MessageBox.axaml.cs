...
public partial class MessageBox : Window
{
        ...
        WindowStartupLocation startupLocation = WindowStartupLocation.CenterScreen)
    {
        ...
        mbox.FindControl<MaterialIcon>("Icone").Kind = MaterialIconKind.InformationCircle;
    ...
    {
        var mbox = new MessageBox(Title, Message);
        mbox.FindControl<MaterialIcon>("Icone").Kind = MaterialIconKind.CheckboxMarkedCircleOutline;
    ...
    {
        var mbox = new MessageBox(Title, Message);
        mbox.FindControl<MaterialIcon>("Icone").Kind = MaterialIconKind.CloseCircleOutline;
