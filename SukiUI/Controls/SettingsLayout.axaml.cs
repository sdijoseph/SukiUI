...
public partial class SettingsLayout : UserControl
{
    ...
    private bool isAnimatingMargin;
    private bool isAnimatingScroll;

    private bool isAnimatingWidth;
            ...
            Children =
            {
                ...
                new KeyFrame
                {
                    Setters =
                    {
                        new Setter
                        {
                            Property = ScrollViewer.OffsetProperty, Value = new Vector(myscroll.Offset.X, desiredScroll)
                        }
                    },
                    KeyTime = TimeSpan.FromMilliseconds(800)
                }
